...
public class Tab1Fragment extends Fragment {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new YourTask().execute(); //fragment is task ?

 //public class  WAQuery extends Fragment{ }


        WAQueryResult queryResult;

        private void WolframAlpha extends AsyncTask<WAQueryResult, Void, WAQueryResult> {
